...
class EvaluateExamAttempt implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $this->attempt->answers()->with(['question', 'selectedOption'])->chunk(500, function ($answers) use (&$totalScore, &$statsUpdates, &$answerUpdates, $exam) {
            ...
            // 5. Wrap all database operations in a DB::transaction()
            Log::info("EvaluateExamAttempt before commit");
            DB::commit();
